...
import { BiDownArrowAlt, BiHeart, BiMessageError, BiReply, BiTrash } from "react-icons/bi";
                ...
                <>
                    ...
                    <div className="p-4 border border-gray-200 rounded-xl">
                        ...
                        <div className="flex flex-col gap-1 w-full items-end text-[13pt] font-extralight">
                            ...
                            {props?.date_updated && <p>{t("games.labels.edited")}: {dayjs(props?.date_updated).format("HH:mm DD.MM.YYYY")}</p>}
                        </div>
                    </div>
