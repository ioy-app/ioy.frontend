const Input: React.FC<{
    ...
    <label className={`box-border border border-br w-full rounded-xl px-4 py-2 has-focus:border-primary has-focus:text-primary transition-colors ${className && className || ""} ${!label && "h-10 px-0 py-0 flex flex-row items-center" || ""}`}>
