...
export default function Terms() {
    ...
    return (
        <div className="flex flex-col gap-2 w-full text-default text-text p-4">
            ...
            <h2 className="text-placeholder">{t("terms.date", { date: "12.04.2026" })}</h2>
            <h2 className="text-placeholder">{t("terms.contact", { contact: "support@ioy.app" })}</h2>
            <p className="pb-4 pt-8">{t("terms.description")}</p>
            <p className="text-danger border border-danger p-4 rounded-xl my-4">{t("terms.age")}</p>
